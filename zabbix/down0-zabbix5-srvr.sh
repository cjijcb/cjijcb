...
#
yum -y install \
https://repo.zabbix.com/zabbix/5.0/rhel/8/x86_64/zabbix-server-mysql-5.0.0-1.el8.x86_64.rpm \
https://repo.zabbix.com/zabbix/5.0/rhel/8/x86_64/zabbix-web-mysql-5.0.0-1.el8.noarch.rpm \
https://repo.zabbix.com/zabbix/5.0/rhel/8/x86_64/zabbix-apache-conf-5.0.0-1.el8.noarch.rpm \
https://repo.zabbix.com/zabbix/5.0/rhel/8/x86_64/zabbix-agent-5.0.0-1.el8.x86_64.rpm \
mariadb-server \
